...
export const advancedDefense: Action[] = [
  ...
  { id: 'd-pull-back', type: 'defense', label: 'PULL BACK', description: 'Pull back and counter', difficulty: 'intermediate', durationMs: 1000 },
  { id: 'd-parry', type: 'defense', label: 'PARRY', description: 'Parry and counter', difficulty: 'advanced', durationMs: 1000 },
  { id: 'd-slip-slip', type: 'defense', label: 'SLIP-SLIP', description: 'Double slip', difficulty: 'advanced', durationMs: 1000 },
  { id: 'd-catch-return', type: 'defense', label: 'CATCH AND RETURN', description: 'Catch the shot, fire back', difficulty: 'advanced', durationMs: 1200 },
  { id: 'd-shoulder-roll', type: 'defense', label: 'SHOULDER ROLL', description: 'Shoulder roll defense', difficulty: 'advanced', durationMs: 1000 },
